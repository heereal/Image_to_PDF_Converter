...
function _ghostIsFirst(evt, vertical, sortable) {
  ...
  var spacer = 10;
  return vertical
    ? evt.clientX < sortableContentRect.left - spacer ||
        (evt.clientY < firstElRect.top && evt.clientX < firstElRect.right)
    : evt.clientY < sortableContentRect.top - spacer ||
...
function _ghostIsLast(evt, vertical, sortable) {
  ...
  var spacer = 10;
  return vertical
    ? evt.clientX > sortableContentRect.right + spacer ||
        (evt.clientY > lastElRect.bottom && evt.clientX > lastElRect.left)
    : evt.clientY > sortableContentRect.bottom + spacer ||
